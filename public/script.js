$(document).ready( function () {
    ...
    var databaseTemp = firebase.database().ref().child('Node_1/Temperature/Temp');
    var databaseHumi = firebase.database().ref().child( 'Node_1/Humidity/Humi' );
    var databaseHumiLand = firebase.database().ref().child('Node_1').child('Soil moisture').child('Soil');

    // Get Temp and Humidity threshold
    var tempMin = firebase.database().ref('Node_1/Temperature/Tempmin');
    var tempMax = firebase.database().ref('Node_1/Temperature/Tempmax');
    var humiMin = firebase.database().ref().child( 'Node_1/Humidity/Hmin' );
    var humiMax = firebase.database().ref().child( 'Node_1/Humidity/Hmax' );
    var humiLandMin = firebase.database().ref().child('Node_1').child('Soil moisture').child('Smin');;
    var humiLandMax = firebase.database().ref().child('Node_1').child('Soil moisture').child('Smax');;
    ...
    var device1 = firebase.database().ref('Node_1/Control/Device1');
    var device2 = firebase.database().ref('Node_1/Control/Device2');
    var device3 = firebase.database().ref('Node_1/Control/Device3');
    var device4 = firebase.database().ref('Node_1/Control/Device4');
    var device5 = firebase.database().ref('Node_1/Control/Device1');
    ...
    //     var device = firebase.database().ref().child( 'Device_' + id );
    //     var x;
